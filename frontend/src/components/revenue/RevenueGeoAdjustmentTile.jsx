...
const RevenueGeoAdjustmentTile = ({ className = '' }) => {
    ...
    if (loading) {
        return (
            <Card className={`${className} border-l-4 border-l-blue-500 !bg-[#151515] !border-[#2a2a2a]`}>
                <div className="p-6 space-y-4">
                    ...
                    <div className="h-12 bg-[#1b1b1b] rounded animate-pulse" />
                    <div className="h-8 bg-[#1b1b1b] rounded animate-pulse" />
                </div>
            </Card>
        );
    }
    ...
    if (error || !tileData) {
        return (
            <Card className={`${className} border-l-4 border-l-red-500 !bg-[#151515] !border-[#2a2a2a]`}>
                <div className="p-6 space-y-4">
    ...
    return (
        <Card className={`${className} border-l-4 !bg-[#151515] !border-[#2a2a2a] ${styles.border.replace('border-', 'border-l-')}`}>
            <div className="p-6 space-y-6 bg-[#151515]">
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            onClick={handleRefresh}
                            disabled={refreshing}
                            className="p-2 hover:bg-[#1b1b1b] rounded-lg transition disabled:opacity-50"
                ...
                {/* Primary Metrics */}
                <div className="grid grid-cols-2 gap-6 py-4 border-y border-[#2a2a2a]">
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[#1b1b1b] p-4 rounded-lg border border-[#2a2a2a]">
                ...
                {/* Confidence Range */}
                <div className="bg-[#1b1b1b] p-3 rounded-lg border border-[#2a2a2a]">
                    <p className="text-xs font-semibold text-gray-300 uppercase mb-2">
                ...
                {isStale && tile_display.staleness_warning && (
                    <div className="bg-[#2a2815] border border-yellow-700 p-3 rounded-lg flex gap-3">
                ...
                {situation_summary.active_signals && situation_summary.active_signals.length > 0 && (
                    <div className="border-t border-[#2a2a2a] pt-4">
                        <button
                            ...
                            className="flex items-center justify-between w-full p-2 hover:bg-[#1b1b1b] rounded transition"
                        >
                            <div className="flex items-center gap-2">
                        ...
                        {showDetails && (
                            <div className="mt-3 space-y-2">
                                {situation_summary.active_signals.slice(0, 5).map((signal, idx) => (
                                    <div
                                        key={idx}
                                        className="bg-[#1b1b1b] p-3 rounded border-l-2 border-l-[#2a2a2a]"
                                    >
                                        <div className="flex items-start justify-between mb-1">
                                            ...
                                            <span className={`text-xs px-2 py-1 rounded ${
                                                signal.confirmed
                                                    ...
                                                    : 'bg-[#151515] text-gray-300 border border-[#2a2a2a]'
                                            }`}>
                                        ...
                                        {signal.impact_channel && signal.impact_channel.length > 0 && (
                                            <div className="mt-2 flex flex-wrap gap-1">
                                                {signal.impact_channel.map((channel, i) => (
                                                    <span
                                                        key={i}
                                                        className="text-xs bg-[#151515] text-gray-300 border border-[#2a2a2a] px-2 py-0.5 rounded"
                                                    >
                                                        {channel.replace(/_/g, ' ')}
                                                    </span>
                                                ))}
                ...
                {suggestions && suggestions.length > 0 && (
                    <div className="border-t border-[#2a2a2a] pt-4">
                        <p className="font-semibold text-white mb-3">Suggested Actions</p>
                ...
                <div className="flex items-center justify-between text-xs text-gray-400 border-t border-[#2a2a2a] pt-4">
                    <span>
